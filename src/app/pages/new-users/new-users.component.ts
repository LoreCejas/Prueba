...
export class NewUsersComponent implements OnInit {
  ...
  newPassword() {
    if (this.form.get('currentPassword').value) {
      ...
      this.form.get('currentPassword').setValidators(null);
