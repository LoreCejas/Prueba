...
const routes: Routes = [
  ...
  {path: 'coops', component: CoopsComponent, canActivate: [AuthGuard]},
  {path: 'socios', component: PartnersComponent, canActivate: [AuthGuard]},
  {path: 'users', component: UsersComponent, canActivate: [AuthGuard]},
  {path: 'transactions', component: TransactionsComponent, canActivate: [AuthGuard]},
  {path: 'coops/:mode', component: NewCoopsComponent, canActivate: [AuthGuard]},
  {path: 'coops/:id/:mode', component: NewCoopsComponent, canActivate: [AuthGuard]},
